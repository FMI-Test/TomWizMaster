...
| ![CRT](images/tw/cpnt-3-crt.png) | +CRT | Increase Critical Damage | **Offense** |
| ![INV](images/tw/cpnt-3-inv.png) | +INV | Decrease Critical Damage | **Defense** |
| ![HIT](images/tw/cpnt-3-hit.png) | +HIT | Increase Hit Rate | **Offense** |
...
|---|---|---|---|
| ![Army ATK](images/tw/cp-talent-army-atk.png) | Army `ATK` » Air DMG Bonus | ![Army HP](images/tw/cp-talent-army-hp.png) | Army `HP` « Air DEF Bonus |
| ![Navy ATK](images/tw/cp-talent-navy-atk.png) | Navy `ATK` » Army DMG Bonus | ![Navy HP](images/tw/cp-talent-navy-hp.png) | Navy `HP` « Army DEF Bonus |
| ![Air ATK](images/tw/cp-talent-air-atk.png) | Air `ATK` » Navy DMG Bonus | ![Air HP](images/tw/cp-talent-air-hp.png) | Air `HP` « Navy DEF Bonus |
