...
## Draft Instruction Example
Wide banner: Tom & Jerry collaborating, constitution + AI brain, gradient purple→blue; text 'GenAI R&D' + subtitle 'A Constitutional Framework'.
Add alt text describing visuals; ensure high contrast per WCAG AA.

## Three‑Model Review
- Model A: Generate candidates
- Model B: Review or provide options
- Model C: Decide and finalize (record rationale)