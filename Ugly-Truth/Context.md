...
> **COMPLIANCE NOTICE:**
> This folder contains sensitive cultural and political context ("The Ugly Truth").
...
Suggest update for Two-words-of-arithmetic.md

Reza.md: Ask follow up if you have difficulty to undertand or to clarify ambigoity or hard time to interpret the tone which  is changes fasst even in one sentence fro a persona to another with a complex to complicated writing style, mostly in Farsi text but resonate to many.

Suggest update for Reza.md (not sure if you even can decipher it and undrestand then reason around it and not overcorrect it or change its tome or message due to misundrestaning - Farsi text)

Suggest update for Reza.md (Englissh section) shouldd be factually correct and clear. this part is not sarcastic it might cut deep but it has a clear message and idea of wht is the proble, ssuggest some options but wnat to start a win-win dialoge and solution.
