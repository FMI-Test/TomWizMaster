...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate executive summary and slide deck markdown files from a JSON/YAML config."
    )
    parser.add_argument("config", type=Path, help="Path to config file (.json, .yaml, or .yml)")
