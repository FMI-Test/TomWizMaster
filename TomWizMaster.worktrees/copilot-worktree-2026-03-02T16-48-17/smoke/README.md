...
- [READ.me.md](../READ.me.md) — Main evolving prompt
- [GEN-BIO-TECH-MODEL-REPORT.md](../GEN-BIO-TECH-MODEL-REPORT.md) — Biotech model analysis
- [PERPLEXITY-UX-ANALYSIS.md](../AI-Guardrails-and-Bias/PERPLEXITY-UX-ANALYSIS.md) — Perplexity deep dive
- [GUARDRAILS.md](../GUARDRAILS.md) — Constitutional guardrails
