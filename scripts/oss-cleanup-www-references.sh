...
if confirm "Regenerate media outputs?"; then
    ...
    echo -e "  ${BLUE}python3 scripts/generate_media_assets.py media/config.yaml${NC}"
    echo ""
...
echo "  1. Regenerate media outputs: python3 scripts/generate_media_assets.py media/config.yaml"
...
echo "  2. Run audit again: scripts/oss-audit-www-references.sh"
